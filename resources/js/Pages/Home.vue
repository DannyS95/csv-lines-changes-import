...
const handleOldData = (file) => {
    form.oldData = file
}

const handleRecentData = (file) => {
    form.recentData = file
}
...
<template>
    ...
    <!-- Main modal -->
    <div v-if="form.errors.oldData || form.errors.recentData" id="default-modal" aria-hidden="true" class="flex items-center justify-center mx-auto z-60 overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
        <div class="relative p-4 w-full max-w-2xl max-h-full">
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <div class="p-4 md:p-5 space-y-4">
                    <p  v-if="form.errors.oldData" class="font-semibold text-lg leading-relaxed text-gray-500 dark:text-gray-400">
                        {{ form.errors.oldData[0] }}.
                    </p>
                    <p  v-if="form.errors.recentData" class="font-semibold text-lg leading-relaxed text-gray-500 dark:text-gray-400">
                        {{ form.errors.recentData[0] }}.
                    </p>
                </div>
            </div>
        </div>
